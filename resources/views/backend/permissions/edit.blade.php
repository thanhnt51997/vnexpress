<div class="modal fade" id="modal_edit_permission" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST"
                      ...
                      enctype="multipart/form-data" id="m_form_edit_permission">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="text" class="form-control m-input" name="name"
                                   placeholder="Nhập dữ liệu...." value="{{ old('name', $permission->name) }}">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="text" class="form-control m-input" name="display_name"
                                   placeholder="Nhập dữ liệu...." value="{{ old('display_name', $permission->display_name) }}">
                        ...
                        <div class="m-form__actions m-form__actions">
                            <div class="row">
                                <div class="col-lg-9 ml-lg-auto">
                                    <button id="submit_edit_permission" type="submit" class="btn btn-accent">Lưu lại</button>
