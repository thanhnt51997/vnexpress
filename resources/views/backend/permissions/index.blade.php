    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Quản lý quyền quản trị</h3>
                ...
                <div class="m-portlet__body">
                    @if (count($permissions) > 0)
                        <section class="data-table-posts">
                            @include('backend.permissions.dataTable')
                        </section>
                    @endif
                </div>
...
@section('script')
    ...
    @include('backend.permissions.indexScript');
@endsection
