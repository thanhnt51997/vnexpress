        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST"
                      ...
                      enctype="multipart/form-data" id="m_form_edit_category">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input" name="name"
                               placeholder="Nhập danh mục bài viết...." value="{{ old('name', $category->name) }}">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 m-form__group">
                            ...
                            <div class="col-12">
                                <select class="form-control m-input" name="status">
                                    ...
                                    <option
                                        value="{{ (config('app.active')) }}" {{ (old('status', $category->status) == config('app.active')) ? 'selected' : ''}}>
                                        Active
                                    </option>
                                    <option
                                        value="{{ config('app.block') }}" {{ (old('status', $category->status) == config('app.block')) ? 'selected' : ''}}>
                                        Disable
                                    </option>
                                </select>
                                <div class="alert alert-danger d-none" id="msg_div">
                        ...
                        <div class="m-form__actions m-form__actions">
                            <div class="row">
                                <div class="col-lg-9 ml-lg-auto">
                                    <button id="submit_edit_category" type="submit" class="btn btn-accent">Lưu lại</button>
