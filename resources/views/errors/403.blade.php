...
<head>
    ...
    <link href="{{ asset('backend/js/bootstrap.min.js') }}" rel="stylesheet">
...
<body>
<div class="container flex-column justify-content-center errors">
    <div class="item text-center">
        <a href="{{route('admin')}}" class="btn btn-primary"><i class="fa fa-home"></i> Quay lại
            Admin</a>
    </div>
    <div class="item text-center">
